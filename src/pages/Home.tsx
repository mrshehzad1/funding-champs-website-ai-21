  ...
  return (
    <>
      <SEO 
        ...
        canonicalUrl="https://championworldwide.com"
      />
      <main>
        <Hero />
        <ProcessSteps />
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Funding Option 1 */}
              <article className="bg-gray-50 rounded-lg p-8 shadow-md hover:shadow-lg transition border-t-4 border-champion-800">
