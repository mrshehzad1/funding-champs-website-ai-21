...
const Footer = () => {
  return <footer className="bg-champion-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4 my-[9px]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <div className="flex items-center space-x-2 mb-2">
              <Phone size={18} />
              <span>917-299-6455</span>
            </div>
            <div className="flex items-center space-x-2">
              <Mail size={18} />
              <span>worldwidefundingchamps@gmail.com</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2">
              <Input type="email" placeholder="Your email address" className="bg-white/10 border-white/20 placeholder:text-white/50" />
